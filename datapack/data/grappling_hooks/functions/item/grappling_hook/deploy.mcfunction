summon armor_stand ~ ~ ~ {Silent:1b,Invulnerable:1b,Small:1b,Marker:0b,Invisible:1b,Tags:["gh.hook","gh.new_hook","global.ignore"],DisabledSlots:4144959}
...
tp @e[tag=gh.new_hook,limit=1] ^ ^ ^2.5
