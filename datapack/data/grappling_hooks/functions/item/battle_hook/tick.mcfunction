...
execute if entity @s[tag=!gh.stuck_hook,tag=!gh.mobstuck_hook] unless block ~ ~ ~-0.3 #grappling_hooks:not_solid run function grappling_hooks:item/battle_hook/stick
execute if entity @s[tag=!gh.stuck_hook,tag=!gh.mobstuck_hook] unless block ~ ~ ~-0.3 #grappling_hooks:not_solid run function grappling_hooks:item/battle_hook/stick
execute if score @s gh.dummy matches 3.. if entity @s[tag=!gh.stuck_hook,tag=!gh.mobstuck_hook] if entity @e[dx=0,dy=0,dz=0,distance=..5,type=!#grappling_hooks:not_pullable] run function grappling_hooks:item/battle_hook/mobstick
